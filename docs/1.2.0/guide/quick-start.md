...
assumes Silverdaw is already [installed](/1.2.0/guide/installation) and open.
...
![The Library tab with the Import button](/1.2.0/images/quickstart-import.png)
...
![The clip right-click menu open on Chop to Grid](/1.2.0/images/quickstart-chop-to-grid.png)
...
![The Track FX panel with its effect modules](/1.2.0/images/quickstart-track-fx.png)
...
- [Arranging the Timeline](/1.2.0/guide/timeline)
- [Editing Clips](/1.2.0/guide/clip-editor)
- [Mixing & Effects](/1.2.0/guide/mixing)
- [Stem Separation](/1.2.0/guide/stems)
