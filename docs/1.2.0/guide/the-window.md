...
![Overview of the Silverdaw window with its main areas labelled](/1.2.0/images/window-overview.png)
...
[markers](/1.2.0/guide/timeline#markers); you can set them to jump to the start
and end of the project in [Preferences ▸ Timeline](/1.2.0/guide/preferences#timeline).
A **Follow playback**
...
tempo. See [the metronome](/1.2.0/guide/timeline#the-metronome) for more.
...
rearrange your material — see [Arranging the Timeline](/1.2.0/guide/timeline).
...
- An **Import** button to bring an audio file straight onto that track (available
  ...
  [Library](/1.2.0/guide/library).
- A **Remove track** button to delete the track.
- A **track effects** toggle that shows or hides the [Track FX](/1.2.0/guide/mixing) for
  that track.
- An **automation** toggle that shows or hides the track's
  [automation lane](/1.2.0/guide/mixing#automation-changing-settings-over-time), where
...
![Close-up of a single track header showing its controls](/1.2.0/images/window-track-header.png)
...
- **Library** — the audio imported into this project, ready to drag onto the
  timeline. See [Importing & the Library](/1.2.0/guide/library).
- **Track FX** — the effects for the selected track. See
  [Mixing & Effects](/1.2.0/guide/mixing).
...
![The bottom panel showing the Library, Track FX, and Project FX tabs](/1.2.0/images/window-bottom-panel.png)
...
remember its own device in [Project Properties](/1.2.0/guide/projects#project-properties).
