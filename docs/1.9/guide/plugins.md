...
Silverdaw's built-in [Track FX](/1.9/guide/mixing#track-fx) cover the essentials,
...
chain that is [exported](/1.9/guide/export).
...
[automation lanes](/1.9/guide/mixing#automation-changing-settings-over-time) —
