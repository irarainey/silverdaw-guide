...
the [Scratch Editor](/1.9/guide/scratch-editor).
...
- **Cue** to move to the previous marker, and **Shift + Cue** to move to the
  ...
  [timeline range](/1.9/guide/timeline#playing-a-timeline-range) counts as a
  marker for these.
...
- **Headphone Cue / PFL** to turn a physical deck's controls on or off in
  ...
  both can be active. In the [Scratch Editor](/1.9/guide/scratch-editor),
...
While the [Scratch Editor](/1.9/guide/scratch-editor) is open, its controls
...
[Scratch Editor](/1.9/guide/scratch-editor), move the physical crossfader once
