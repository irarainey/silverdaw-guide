...
assumes Silverdaw is already [installed](/1.9/guide/installation) and open.
...
without leaving Silverdaw. See [Browsing Files](/1.9/guide/files).
:::

![The Library panel with imported audio](/1.9/images/quickstart-import.png)
...
![The clip right-click menu open on Chop to Grid](/1.9/images/quickstart-chop-to-grid.png)
...
![The Track FX panel with its effect modules](/1.9/images/quickstart-track-fx.png)
...
- [Arranging the Timeline](/1.9/guide/timeline)
- [Editing Clips](/1.9/guide/clip-editor)
- [Mixing & Effects](/1.9/guide/mixing)
- [Recording Audio](/1.9/guide/recording)
- [Stem Separation](/1.9/guide/stems)
