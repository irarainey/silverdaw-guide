...
playback — arrangement, effects, plugins, automation, fades, and turntable
effects — is rendered into the file exactly as it plays.
...
![The Export Mixdown dialog](/1.9/images/export-dialog.png)
