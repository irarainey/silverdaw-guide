...
![The Separate Stems dialog with parts selected](/1.9/images/stems-dialog.png)

### Separating straight from the Library

You don't need a clip on the timeline to separate a track. Right-click an item in
the [Library](/1.9/guide/library) and choose **Separate Stems** to run the same
...
- **Separate short sections, not whole songs.** You rarely need every stem of an
  entire track. Trim or [split](/1.9/guide/timeline#moving-and-editing-clips) the clip
...
[effects](/1.9/guide/mixing), or [slice them into loops](/1.9/guide/clip-editor) — all the
