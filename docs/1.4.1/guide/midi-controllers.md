...
the [Scratch Editor](/1.4.1/guide/scratch-editor).
...
- **Headphone Cue / PFL** to turn a physical deck's controls on or off in
  ...
  both can be active. In the [Scratch Editor](/1.4.1/guide/scratch-editor),
...
While the [Scratch Editor](/1.4.1/guide/scratch-editor) is open, its controls
...
[Scratch Editor](/1.4.1/guide/scratch-editor), move the physical crossfader once
