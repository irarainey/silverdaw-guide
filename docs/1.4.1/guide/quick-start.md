...
assumes Silverdaw is already [installed](/1.4.1/guide/installation) and open.
...
![The Library panel with imported audio](/1.4.1/images/quickstart-import.png)
...
![The clip right-click menu open on Chop to Grid](/1.4.1/images/quickstart-chop-to-grid.png)
...
![The Track FX panel with its effect modules](/1.4.1/images/quickstart-track-fx.png)
...
- [Arranging the Timeline](/1.4.1/guide/timeline)
- [Editing Clips](/1.4.1/guide/clip-editor)
- [Mixing & Effects](/1.4.1/guide/mixing)
- [Stem Separation](/1.4.1/guide/stems)
