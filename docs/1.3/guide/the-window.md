...
[markers](/1.3/guide/timeline#markers); you can set them to jump to the start
and end of the project in [Preferences ▸ Timeline](/1.3/guide/preferences#timeline).
A **Follow playback**
...
tempo. See [the metronome](/1.3/guide/timeline#the-metronome) for more.
...
rearrange your material — see [Arranging the Timeline](/1.3/guide/timeline).
...
- An **Import** button to bring an audio file straight onto that track (available
  ...
  [Library](/1.3/guide/library).
- A **Remove track** button to delete the track.
- A **track effects** toggle that shows or hides the [Track FX](/1.3/guide/mixing) for
  that track.
- An **automation** toggle that shows or hides the track's
  [automation lane](/1.3/guide/mixing#automation-changing-settings-over-time), where
...
![Close-up of a single track header showing its controls](/1.3/images/window-track-header.png)
...
- **Library** — the audio imported into this project, ready to drag onto the
  timeline. See [Importing & the Library](/1.3/guide/library).
...
remember its own device in [Project Properties](/1.3/guide/projects#project-properties).
