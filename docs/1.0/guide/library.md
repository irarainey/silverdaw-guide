...
on library tiles** in [Preferences ▸ General](/1.0/guide/preferences#general).

A small **type badge** in the bottom-right corner of each tile marks what the
item is —
a **Track** (imported audio), a **Stem** from [stem separation](/1.0/guide/stems), or
...
![The Library panel with grouped imported items](/1.0/images/library-panel.png)

### Sample rate check

Each project has a [sample rate](/1.0/guide/projects#project-properties) (44.1 or
...
- **Save Clip to Library** — right-click a clip and choose **Save Clip to
  ...
  clips**. Copies you drag onto the timeline stay [linked](/1.0/guide/library#linked-clips)
...
[Slicing loops](/1.0/guide/clip-editor#slicing-a-clip-into-loops).
...
You make these changes in the [Clip Editor](/1.0/guide/clip-editor) (they apply when
...
[Preferences ▸ Project](/1.0/guide/preferences#project), removing a stem or sample
