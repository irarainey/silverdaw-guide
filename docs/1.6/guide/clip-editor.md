...
**Open ▸ Scratch Editor**. See [Scratch Editor](/1.6/guide/scratch-editor).
...
- **A [linked clip](/1.6/guide/library#linked-clips)** — or a **saved clip** opened
...
[linked clips](/1.6/guide/library#linked-clips)).

![The Clip Editor window](/1.6/images/clip-editor.png)
...
- **Editing a clip.** Double-click a clip's body on the timeline, or right-click
  ...
  **Save**.
- **Previewing a file.** Double-click a [Library](/1.6/guide/library) tile (anywhere
...
- **Metronome** — the metronome button in the transport (or the <kbd>K</kbd> key)
  ...
  [timeline metronome](/1.6/guide/timeline#the-metronome), and it isn't shown when
...
new saved clip you can reuse — the same [saved clips](/1.6/guide/library#saved-clips-and-samples)
...
[Beat markers and how they are worked out](/1.6/guide/timeline#beat-markers-and-how-they-are-worked-out).
Working in shorter pieces gives the analysis far less to average over:

1. [Split](/1.6/guide/timeline#moving-and-editing-clips) or trim the clip down to a
...
2. Right-click it and choose **Library ▸ Save as Sample…**, then choose
   **Music** to bake that section into a new
   [music sample](/1.6/guide/library#music-and-simple-samples) in the Library.
3. Right-click the new sample in the [Library](/1.6/guide/library) and choose
...
- **Slice to samples** — save each slice as its own sample in the
  [Library](/1.6/guide/library) to reuse and rebuild.
