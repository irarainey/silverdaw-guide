...
assumes Silverdaw is already [installed](/1.6/guide/installation) and open.
...
your drives, so you can listen to a track and import it without leaving
Silverdaw. See [Browsing Files](/1.6/guide/files).
:::

![The Library panel with imported audio](/1.6/images/quickstart-import.png)
...
![The clip right-click menu open on Chop to Grid](/1.6/images/quickstart-chop-to-grid.png)
...
![The Track FX panel with its effect modules](/1.6/images/quickstart-track-fx.png)
...
- [Arranging the Timeline](/1.6/guide/timeline)
- [Editing Clips](/1.6/guide/clip-editor)
- [Mixing & Effects](/1.6/guide/mixing)
- [Stem Separation](/1.6/guide/stems)
