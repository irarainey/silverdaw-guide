...
![Overview of the Silverdaw window with its main areas labelled](/1.6/images/window-overview.png)
...
[markers](/1.6/guide/timeline#markers); you can set them to jump to the start
and end of the project in [Preferences ▸ Timeline](/1.6/guide/preferences#timeline).
A **Follow playback**
toggle decides whether the timeline scrolls to keep up with the playhead or stays
still while you play.

When you have a [timeline range](/1.6/guide/timeline#playing-a-timeline-range),
...
material — see [Arranging the Timeline](/1.6/guide/timeline).
...
- A **grid** control (grid icon) that sets how coarse the timeline grid is:
  **Bar**, **Beat**, **Half beat**, **Quarter beat**, or **Free**. This is the
  ...
  [Choosing the grid](/1.6/guide/timeline#choosing-the-grid).
...
- An **Import** button to bring an audio file straight onto that track (available
  ...
  [Library](/1.6/guide/library).
- A **Remove track** button to delete the track.
- A **track effects** toggle that shows or hides the [Track FX](/1.6/guide/mixing) for
  that track.
- An **automation** toggle that shows or hides the track's
  [automation lanes](/1.6/guide/mixing#automation-changing-settings-over-time), where
...
![Close-up of a single track header showing its controls](/1.6/images/window-track-header.png)

## The bottom panel

The panel across the bottom has four tabs:

- **Files** — browse folders of audio on your drives, listen to a track, and
  import it. See [Browsing Files](/1.6/guide/files).
- **Library** — the audio imported into this project, ready to drag onto the
  timeline. See [Importing & the Library](/1.6/guide/library).
- **Track FX** — the effects for the selected track. See
  [Mixing & Effects](/1.6/guide/mixing).
...
![The bottom panel showing its tabs](/1.6/images/window-bottom-panel.png)
...
remember its own device in [Project Properties](/1.6/guide/projects#project-properties).
...
[Editing Clips](/1.6/guide/clip-editor).
