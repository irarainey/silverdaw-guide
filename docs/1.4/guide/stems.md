...
![The Separate Stems dialog with parts selected](/1.4/images/stems-dialog.png)
...
- **Separate short sections, not whole songs.** You rarely need every stem of an
  entire track. Trim or [split](/1.4/guide/timeline#moving-and-editing-clips) the clip
...
[effects](/1.4/guide/mixing), or [slice them into loops](/1.4/guide/clip-editor) — all the
