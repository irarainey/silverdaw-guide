...
![Overview of the Silverdaw window with its main areas labelled](/1.4/images/window-overview.png)
...
[markers](/1.4/guide/timeline#markers); you can set them to jump to the start
and end of the project in [Preferences ▸ Timeline](/1.4/guide/preferences#timeline).
A **Follow playback**
toggle decides whether the timeline scrolls to keep up with the playhead or stays
still while you play.

When you have a [timeline range](/1.4/guide/timeline#playing-a-timeline-range),
...
tempo. See [the metronome](/1.4/guide/timeline#the-metronome) for more.
...
material — see [Arranging the Timeline](/1.4/guide/timeline).
...
- An **Import** button to bring an audio file straight onto that track (available
  ...
  [Library](/1.4/guide/library).
- A **Remove track** button to delete the track.
- A **track effects** toggle that shows or hides the [Track FX](/1.4/guide/mixing) for
  that track.
- An **automation** toggle that shows or hides the track's
  [automation lanes](/1.4/guide/mixing#automation-changing-settings-over-time), where
...
![Close-up of a single track header showing its controls](/1.4/images/window-track-header.png)
...
- **Library** — the audio imported into this project, ready to drag onto the
  timeline. See [Importing & the Library](/1.4/guide/library).
...
![The bottom panel showing the Library, Track FX, and Project FX tabs](/1.4/images/window-bottom-panel.png)
...
remember its own device in [Project Properties](/1.4/guide/projects#project-properties).
