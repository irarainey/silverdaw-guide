...
![Overview of the Silverdaw window with its main areas labelled](/1.8/images/window-overview.png)
...
[markers](/1.8/guide/timeline#markers); you can set them to jump to the start
and end of the project in [Preferences ▸ Timeline](/1.8/guide/preferences#timeline).
A **Follow playback**
toggle decides whether the timeline scrolls to keep up with the playhead or stays
still while you play.

When you have a [timeline range](/1.8/guide/timeline#playing-a-timeline-range),
...
See [Changing the project tempo](/1.8/guide/timeline#changing-the-project-tempo).
It also includes a **Metronome** click you can switch on to hear a tick in time
with the project tempo. See
[the metronome](/1.8/guide/timeline#the-metronome) for more.
...
material — see [Arranging the Timeline](/1.8/guide/timeline).
...
- A **grid** control (grid icon) that sets how coarse the timeline grid is:
  **Bar**, **Beat**, **Half beat**, **Quarter beat**, or **Free**. This is the
  ...
  [Choosing the grid](/1.8/guide/timeline#choosing-the-grid).
...
- An **Import** button to bring an audio file straight onto that track (available
  ...
  [Library](/1.8/guide/library).
- A **Remove track** button to delete the track.
- A **track effects** toggle that shows or hides the [Track FX](/1.8/guide/mixing) for
  that track.
- An **automation** toggle that shows or hides the track's
  [automation lanes](/1.8/guide/mixing#automation-changing-settings-over-time), where
...
![Close-up of a single track header showing its controls](/1.8/images/window-track-header.png)
...
![The bottom panel showing its tabs](/1.8/images/window-bottom-panel.png)
...
remember its own device in [Project Properties](/1.8/guide/projects#project-properties).
...
[Editing Clips](/1.8/guide/clip-editor).
