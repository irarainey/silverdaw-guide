...
![The Project Properties dialog](/1.8/images/project-properties.png)
...
- **Audio device** and **Audio driver** — an optional output device just for this
  ...
  the default available device and shows **Saved Audio Device Not Available**.
...
[Importing from another project](/1.8/guide/library#importing-from-another-project).
