...
assumes Silverdaw is already [installed](/1.8/guide/installation) and open.
...
without leaving Silverdaw. See [Browsing Files](/1.8/guide/files).
:::

![The Library panel with imported audio](/1.8/images/quickstart-import.png)
...
![The clip right-click menu open on Chop to Grid](/1.8/images/quickstart-chop-to-grid.png)
...
![The Track FX panel with its effect modules](/1.8/images/quickstart-track-fx.png)
...
- [Arranging the Timeline](/1.8/guide/timeline)
- [Editing Clips](/1.8/guide/clip-editor)
- [Mixing & Effects](/1.8/guide/mixing)
- [Stem Separation](/1.8/guide/stems)
