...
dragged from the [Files tab](/1.8/guide/files) works the same way. As you drag, a
...
[Browsing Files](/1.8/guide/files).
...
on library tiles** in [Preferences ▸ General](/1.8/guide/preferences#general).

A small **type badge** in the bottom-right corner of each tile marks what the
item is — a **Track** (imported audio), a **Stem** from
[stem separation](/1.8/guide/stems), a saved **Sample**, or a **Scratch** — so
...
![The Library with imported audio, stems, a saved clip, and the Filter library field](/1.8/images/library-panel.png)

### Sample rate check

Each project has a [sample rate](/1.8/guide/projects#project-properties) (44.1 or
...
1. Choose a project to see its available **Stems** and **Samples**.
...
[Scratch Editor](/1.8/guide/scratch-editor). Missing or unreadable files are
...
<!-- Image placeholder: the Import from Project dialog with a source project and selected samples. -->
...
track — from Windows Explorer or from the [Files tab](/1.8/guide/files) — to
...
see [Beat markers and how they are worked out](/1.8/guide/timeline#beat-markers-and-how-they-are-worked-out).
...
- **Save Clip to Library** — right-click a clip and choose **Library ▸ Save Clip
  ...
  clips**. Copies you drag onto the timeline stay [linked](/1.8/guide/library#linked-clips)
...
[Slicing loops](/1.8/guide/clip-editor#slicing-a-clip-into-loops).
...
You make these changes in the [Clip Editor](/1.8/guide/clip-editor) (they apply when
...
- **Separate Stems** — split the item into **Vocals**, **Drums**, **Bass**, and
  **Other**. The stems are added to the Library only; drag them onto tracks
  yourself. See [Stem Separation](/1.8/guide/stems#separating-straight-from-the-library).
...
- **Open in Scratch Editor** — create or continue a scratch pattern from the
  item. See [Scratch Editor](/1.8/guide/scratch-editor).
...
[Preferences ▸ Project](/1.8/guide/preferences#project), removing a stem or sample
...
The file's [beat markers](/1.8/guide/timeline#beat-markers-and-how-they-are-worked-out)
...
- A [crossfade](/1.8/guide/timeline#crossfading-between-clips) between two clips is
  **removed** if the clips no longer overlap.
- A clip can end up extending **past the project length**, which you can change in
  [Project Properties](/1.8/guide/projects#project-properties).
...
[When the beat markers drift](/1.8/guide/timeline#when-the-beat-markers-drift).
...
[Changing the project tempo](/1.8/guide/timeline#changing-the-project-tempo).
