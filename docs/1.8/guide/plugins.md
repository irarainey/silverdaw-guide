...
Silverdaw's built-in [Track FX](/1.8/guide/mixing#track-fx) cover the essentials,
...
chain that is [exported](/1.8/guide/export).
...
[automation lanes](/1.8/guide/mixing#automation-changing-settings-over-time) —
