...
before the track's volume, pan, and sends. See [Plugins](/1.8/guide/plugins).
...
- **Brake** slows the final part of a clip down to a stop, like pressing stop on a
  ...
  **Edit ▸ Preferences… ▸ Effects**. See
  [Brake and Backspin](/1.8/guide/clip-editor#turntable-effects-brake-and-backspin).
...
- **Scratch realism** applies only while a platter is held in the
  [Scratch Editor](/1.8/guide/scratch-editor#scratch-realism). It softens the
...
![A track with its automation lane open and a breakpoint curve](/1.8/images/mixing-automation.png)
...
[change the project tempo](/1.8/guide/timeline#changing-the-project-tempo), every
