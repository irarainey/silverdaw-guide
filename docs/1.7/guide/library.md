...
dragged from the [Files tab](/1.7/guide/files) works the same way. As you drag, a
...
[Browsing Files](/1.7/guide/files).
...
on library tiles** in [Preferences ▸ General](/1.7/guide/preferences#general).

A small **type badge** in the bottom-right corner of each tile marks what the
item is — a **Track** (imported audio), a **Stem** from
[stem separation](/1.7/guide/stems), a saved **Sample**, or a **Scratch** — so
...
![The Library with imported audio, stems, a saved clip, and the Filter library field](/1.7/images/library-panel.png)

### Sample rate check

Each project has a [sample rate](/1.7/guide/projects#project-properties) (44.1 or
...
[Scratch Editor](/1.7/guide/scratch-editor). Missing or unreadable files are
...
track — from Windows Explorer or from the [Files tab](/1.7/guide/files) — to
...
see [Beat markers and how they are worked out](/1.7/guide/timeline#beat-markers-and-how-they-are-worked-out).
...
- **Save Clip to Library** — right-click a clip and choose **Library ▸ Save Clip
  ...
  clips**. Copies you drag onto the timeline stay [linked](/1.7/guide/library#linked-clips)
...
[Slicing loops](/1.7/guide/clip-editor#slicing-a-clip-into-loops).
...
You make these changes in the [Clip Editor](/1.7/guide/clip-editor) (they apply when
...
- **Open in Scratch Editor** — create or continue a scratch pattern from the
  item. See [Scratch Editor](/1.7/guide/scratch-editor).
...
[Preferences ▸ Project](/1.7/guide/preferences#project), removing a stem or sample
