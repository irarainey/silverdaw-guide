...
[Quick Start](/1.7/guide/quick-start) and build your first remix in a few minutes.
Otherwise, start with [Installation](/1.7/guide/installation), then take the
[tour of the Silverdaw window](/1.7/guide/the-window).

If terms like *sample rate*, *bit depth*, or *WAV* are new to you,
[Digital Audio Basics](/1.7/guide/digital-audio-basics) explains them in plain
language. You do not need it to make a mix.

> This guide targets Silverdaw version 1.7.x.
