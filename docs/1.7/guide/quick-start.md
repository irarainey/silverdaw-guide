...
assumes Silverdaw is already [installed](/1.7/guide/installation) and open.
...
::: tip
No file to hand? The **Files** tab beside the Library browses folders of audio on
your drives, so you can listen to a track and drag it straight onto the timeline
without leaving Silverdaw. See [Browsing Files](/1.7/guide/files).
:::

![The Library panel with imported audio](/1.7/images/quickstart-import.png)
...
> [Changing the project tempo](/1.7/guide/timeline#changing-the-project-tempo).
...
> and holding <kbd>Alt</kbd> while you drag places a clip freely.
...
![The clip right-click menu open on Chop to Grid](/1.7/images/quickstart-chop-to-grid.png)
...
![The Track FX panel with its effect modules](/1.7/images/quickstart-track-fx.png)
...
- [Arranging the Timeline](/1.7/guide/timeline)
- [Editing Clips](/1.7/guide/clip-editor)
- [Mixing & Effects](/1.7/guide/mixing)
- [Stem Separation](/1.7/guide/stems)
