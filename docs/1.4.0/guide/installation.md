...
[tour of the Silverdaw window](/1.4.0/guide/the-window) first.

> If you do not hear anything when you press play, check that the right audio
> output is selected. See [Choosing your audio output](/1.4.0/guide/the-window#choosing-your-audio-output).
