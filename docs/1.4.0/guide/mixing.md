...
- **Scratch realism** applies only while a platter is held in the
  [Scratch Editor](/1.4.0/guide/scratch-editor#scratch-realism). It softens the
...
![A track with its automation lane open and a breakpoint curve](/1.4.0/images/mixing-automation.png)
