...
[markers](/1.4.0/guide/timeline#markers); you can set them to jump to the start
and end of the project in [Preferences ▸ Timeline](/1.4.0/guide/preferences#timeline).
A **Follow playback**
toggle decides whether the timeline scrolls to keep up with the playhead or stays
still while you play.

When you have a [timeline range](/1.4.0/guide/timeline#playing-a-timeline-range),
...
tempo. See [the metronome](/1.4.0/guide/timeline#the-metronome) for more.
...
material — see [Arranging the Timeline](/1.4.0/guide/timeline).
...
![Close-up of a single track header showing its controls](/1.4.0/images/window-track-header.png)
...
- **Library** — the audio imported into this project, ready to drag onto the
  timeline. See [Importing & the Library](/1.4.0/guide/library).
- **Track FX** — the effects for the selected track. See
  [Mixing & Effects](/1.4.0/guide/mixing).
...
remember its own device in [Project Properties](/1.4.0/guide/projects#project-properties).
...
[Editing Clips](/1.4.0/guide/clip-editor).
