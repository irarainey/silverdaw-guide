...
the [Scratch Editor](/1.5/guide/scratch-editor).
...
- **Cue** to move to the previous marker, and **Shift + Cue** to move to the
  ...
  [timeline range](/1.5/guide/timeline#playing-a-timeline-range) counts as a
  marker for these.
...
- **Headphone Cue / PFL** to turn a physical deck's controls on or off in
  ...
  both can be active. In the [Scratch Editor](/1.5/guide/scratch-editor),
...
- A **Browse** control to navigate tracks and clips:
  ...
  - Hold **Shift** while turning **Browse** to zoom the timeline when
    ...
    **Shift** control.
- Hot-cue pads to jump to numbered timeline markers. Where supported, a shifted
  or dedicated clear pad toggles a marker at the playhead — removing the marker
  the playhead sits on, or adding one there when it isn't on one. This is the
  same action as the <kbd>M</kbd> key.
...
While the [Scratch Editor](/1.5/guide/scratch-editor) is open, its controls
...
[Scratch Editor](/1.5/guide/scratch-editor), move the physical crossfader once
